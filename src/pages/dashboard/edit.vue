<template>
  <div class="pt-4 pb-10 bg-white">
    <!-- <div v-if="manageCount == 1" class="">
      <manage @singleBucket="toggleNext" />
    </div> -->
    <div v-if="manageCount == 2">
      <button
        @click="togglePrev"
    ...
    <section class="flex items-center justify-center mx-auto mt-20 mb-20 gap-7">
      <div
    ...
    <div v-show="activeTab === 1">
      ...
      <div>
        <p class="text-lg font-semibold font-poppins pt-7">Delete Fundraiser</p>
        <div class="flex items-center justify-between">
          <p class="text-sm font-medium font-poppins text-[#999999]">
            Deleting will remove your donation campaign from people to donate to
            you.
          </p>
          <button
